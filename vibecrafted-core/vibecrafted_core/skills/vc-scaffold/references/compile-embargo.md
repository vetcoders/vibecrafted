...
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Local worker checkpoint            | Worker commits in its Fleet Worktree and stops. No worker push, publication, or remote `embargo/<plan-id>` ref; a push using `--no-verify` is an exclusive Founder button.                          | Exact SHA, scope, and report of gates run/skipped. The bundled hook entrypoint may be bypassed; this is neither security-clean nor verified delivery.           |
