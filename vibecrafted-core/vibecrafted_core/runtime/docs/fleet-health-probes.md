...
| --- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Mission Control "Fleet health" panel** | `vibecrafted-app/tui-agent/src/mission_control.rs:890` `fleet_health_from_inputs()`; struct `FleetHealthSignal{label,status,detail}` at `:116`; enum `FleetHealthStatus{Ok,Warn,Blocked,Unknown}` at `:122`                                                      | Pushes exactly 5 signals: `control-plane`, `artifact-root`, `derived runs`, `model parity`, `duration parity`                            | All five are **about the dashboard's own data quality** (is the control-plane dir present, were derived snapshots folded, are model/duration fields populated). Zero substrate signals — no disk, no aicx index, no MCP reachability, no mesh. This is the seam the probes extend. |
