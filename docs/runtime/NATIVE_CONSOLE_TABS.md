...
| Usage & Costs       | `/usage` on the connected runtime. The page projects canonical run metadata with time/provider/agent/model filters, explicit unknowns, failures, and costs separated by unit.                                                                                                                                                                                                                                                                  | no runtime → menu item disabled with reason                                                                                                                                                |
